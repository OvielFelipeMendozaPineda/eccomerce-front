...
const inputsPedido = [
    { type: 'date', id: 'name', name: 'name', autoComplete: 'name', labelText: '¿Para cuándo?  ', placeholder: '', required: 'required', className: 'rounded-lg p-1.5 mb-3 w-full ', maxLength: 50 },
    { type: 'text', id: 'name', name: 'name', autoComplete: 'name', labelText: 'Describe tu pedido', placeholder: '', required: 'required', className: 'rounded-lg p-1.5 mb-3 w-full ', maxLength: 50 },
...
export default function ProductsPage() {
  ...
  return (
    <>
      <div className='flex flex-col w-full h-screen'>
        ...
        <div className='flex justify-end w-96'>
          <div className='w-96 my-5'>
            <Button children={'Crear nuevo pedido'} id={"create-product-btn"} className={'bg-gray-200 w-full p-3 rounded-xl font-medium hover:bg-gray-300'} onClick={handleModal} type={'button'} />
          </div>
        </div>
        <div className='mt-10'>
          <Table
      ...
      <Modal modalTitle="Crear nuevo pedido" fields={inputsPedido} handleSubmit={handleSubmit}  show={showModal} handleModal={handleModal} />
