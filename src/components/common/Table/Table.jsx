      ...
      <table className="flex-1">
        <thead>
          <tr className="bg-[#f8fafb]">
            ...
            {notShow ? (<th className='table-ec883312-db4a-45d6-8895-5f43c9f4c6a2-column-176 px-4 py-3 text-left text-[#0e141b] w-[400px] text-sm font-medium leading-normal'>
              Status
            </th>) : ""}
            <th className='table-ec883312-db4a-45d6-8895-5f43c9f4c6a2-column-176  py-3 text-center text-[#0e141b] text-sm font-bold'>
              Editar
            </th>
          </tr>
        </thead>
